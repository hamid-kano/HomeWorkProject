...
@section('title', 'القسم القانوني')
@section('page-title', 'القسم القانوني')
...
<div class="bg-white/70 backdrop-blur-sm rounded-2xl shadow-lg p-6 border border-white/20">
    <div class="flex items-center gap-3 mb-6">
        ...
        <h2 class="text-2xl font-bold text-secondary-900">القسم القانوني</h2>
    </div>
    <p class="text-secondary-600">إدارة الشؤون القانونية والعقود</p>
</div>
@endsection